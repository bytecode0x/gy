...
const Folder4 = () => {
  return (
    <svg
      ...
      x='0px'
      y='0px'
      viewBox='0 0 216.139 216.139'
      // style='enable-background:new 0 0 216.139 216.139;'
    >
      <path
        d='M208.639,42.197h-17.197V15.931c0-4.142-3.358-7.5-7.5-7.5h-43.338H97.27H53.938H7.5c-4.142,0-7.5,3.358-7.5,7.5v184.276
