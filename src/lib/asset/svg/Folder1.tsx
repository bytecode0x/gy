...
const Folder1 = () => {
  return (
    <svg
      ...
      width='466.071px'
      height='466.071px'
      viewBox='0 0 466.071 466.071'
      // style='enable-background:new 0 0 466.071 466.071;'
    >
      <g>
        <path
          d='M466.07,150.951c0-32.526-26.469-58.988-59.004-58.988h-85.345V76.452c0-11.642-9.469-21.112-21.106-21.112H21.109
