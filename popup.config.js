...
module.exports = (env) => {
  ...
  const config = {
    ...
    entry: {
      index : path.resolve(__dirname, 'src/local/extension/popup/index.ts'),
    },
    output: {
      path: path.resolve(__dirname, path.join('bundle', 'extension')),
      // publicPath: '/',
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        template: 'src/local/extension/popup/index.html',
        filename: 'popup.html'
      })
    ],
    module: {
